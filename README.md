...
```
curl -O https://raw.githubusercontent.com/lamassu/lamassu-install/release-10.2/install && bash install
```
...
```
curl -sS https://raw.githubusercontent.com/lamassu/lamassu-install/release-10.2/upgrade-ls | bash
```
