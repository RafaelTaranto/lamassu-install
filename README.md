...
```
curl -O https://raw.githubusercontent.com/lamassu/lamassu-install/release-10.1/install && bash install
```
...
```
curl -sS https://raw.githubusercontent.com/lamassu/lamassu-install/release-10.1/upgrade-ls | bash
```
